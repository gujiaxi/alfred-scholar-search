...
# params = {'AllField': query, 'pageSize': 10}
...
# articles = BeautifulSoup(r.text, 'html5lib', parse_only=only_table)
...
for art in articles:
    ...
    # get title
    title = art.find('div', {'class': 'art_title'}).find('span', {'class': 'hlFld-Title'}).contents[0]
